...
<body>
  <div class="wrapper">
        ...
        <div class="container">
            ...
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav__item with-dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  <!-- /.nav-item -->
                  <li class="nav__item"><a href="menu-cards.html" class="nav__item-link">Menu Card</a></li>
                  <!-- /.nav-item -->
                </ul><!-- /.dropdown-menu -->
              </li><!-- /.nav-item -->
              <li class="nav__item with-dropdown">
          ...
          <div class="navbar-actions-wrap">
            <div class="navbar-actions d-flex align-items-center">
              <a href="reservation.html" class="navbar__action-btn navbar__action-btn-reserve btn">Reservation</a>
        ...
        <div class="row">
          <div class="col-sm-12 col-md-12 col-lg-6 offset-lg-3">
            <div class="heading heading-layout1 text-center mb-40">
              ...
              <p class="heading__desc">Even if you're not a great chef, there's nothing to stop you understanding the
    ...
    <!-- ========================
       text Banner Layout2
    =========================== -->
    <section class="text-banner text-banner-layout2 text-center bg-overlay bg-overlay-gradient bg-parallax">
    ...
    <!-- ========================
        Menu layout 2
    =========================== -->
    <section class="menu-layout2 pb-60">
      <div class="container">
        <div class="row">
            ...
            <div class="menu-wrapper">
              <div class="menu-item">
                ...
                <div class="menu__item-content">
                  <h4 class="menu__item-title">Grilled Fillet</h4>
                  <p class="menu__item-desc">Pork fillet, ginger, garlic, honey, pepper & canola oil, Pork fillet,
                    ginger.</p>
                  <span class="menu__item-price">$26.95</span>
                </div>
              </div><!-- /.menu-item -->
              ...
              <div class="menu-item">
                ...
                <div class="menu__item-content">
                  ...
                  <p class="menu__item-desc">Mint parsley with apple cider vinegar, salt & spices, parsley with apple
                    cider.</p>
            ...
            <div class=" col-sm-12 col-md-12 col-lg-4">
              <div class="contact-box">
                ...
                <ul class="contact__box-list list-unstyled">
                  <li>22 Alnahas Building, 2 AlBahr St, Tanta <br> Al-Gharbia Governorate, Egypt</li>
                </ul>
